...
const screenshotKeys = ["orders", "vendors", "analytics"];
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					<div className="inline-flex items-center px-4 py-2 bg-amber-100 text-amber-800 rounded-full text-sm font-semibold mb-6">
						...
						{t("purchasing.screenshots.badge")}
					</div>
					<h2 className="text-enterprise-primary mb-6">
						{t("purchasing.screenshots.title")}
					</h2>
					<p className="text-xl text-enterprise-secondary max-w-3xl mx-auto">
						{t("purchasing.screenshots.subtitle")}
					</p>
				</div>

				<div className="space-y-20">
					{screenshotKeys.map((screenshotKey, index) => {
						const features = t(`purchasing.screenshots.${screenshotKey}.features`, {
							returnObjects: true,
						});
							...
							>
								<div className={`${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
									<div className="relative">
										<div className="absolute inset-0 bg-gradient-to-r from-amber-600/10 to-orange-700/10 rounded-3xl transform rotate-2"></div>
										<img
											src={screenshots[index].image}
											alt={t(`purchasing.screenshots.${screenshotKey}.title`)}
								...
								>
									<div>
										<h3 className="text-3xl font-bold text-enterprise-primary mb-4">
											{t(`purchasing.screenshots.${screenshotKey}.title`)}
										</h3>
										<p className="text-xl text-enterprise-secondary leading-relaxed">
											{t(`purchasing.screenshots.${screenshotKey}.description`)}
										</p>
									</div>
									...
									<button className="btn-primary">
										{t("purchasing.screenshots.exploreFeature")}
									</button>
								</div>
							</div>
						);
