...
export default function Testimonials() {
	...
	const testimonials = t("simklinik.testimonials.items", {
		returnObjects: true,
	}) as Array<{
		quote: string;
		author: string;
				...
				<div className="mt-16 text-center">
					<div className="card-enterprise p-8 max-w-2xl mx-auto">
						<h3 className="text-2xl font-bold text-enterprise-primary mb-4">
							{t("simklinik.testimonials.joinSuccess.title")}
						</h3>
						<p className="text-enterprise-secondary mb-6">
							{t("simklinik.testimonials.joinSuccess.description")}
						</p>
						<button className="btn-primary">
							{t("simklinik.testimonials.joinSuccess.scheduleDemo")}
						</button>
					</div>
				</div>
			</div>
