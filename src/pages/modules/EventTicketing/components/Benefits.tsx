...
const benefitKeys = ["speed","revenue","satisfaction","efficiency"];
const benefitIcons = [Zap, TrendingUp, Award, Clock];
						...
						return (
							<div key={benefitKey} className="card-enterprise p-8 text-center group">
								...
								<div className="text-3xl font-bold text-blue-600 mb-2">
									{t(`eventTicketing.benefits.${benefitKey}.stat`)}
								</div>
								<h3 className="text-xl font-bold text-enterprise-primary mb-3">
									{t(`eventTicketing.benefits.${benefitKey}.title`)}
								</h3>
								<p className="text-enterprise-secondary leading-relaxed">
									{t(`eventTicketing.benefits.${benefitKey}.description`)}
								</p>
							</div>
						);
					})}
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
							<div className="text-center">
								...
								<p className="text-enterprise-muted">
									{t("eventTicketing.benefits.organizations")}
								</p>
							</div>
							<div className="text-center">
								<div className="text-4xl font-bold text-indigo-600 mb-2">99.9%</div>
								<p className="text-enterprise-muted">
									{t("eventTicketing.benefits.uptime")}
								</p>
							</div>
							<div className="text-center">
								<div className="text-4xl font-bold text-blue-600 mb-2">24/7</div>
								<p className="text-enterprise-muted">
									{t("eventTicketing.benefits.support")}
								</p>
							</div>
						</div>
					</div>
