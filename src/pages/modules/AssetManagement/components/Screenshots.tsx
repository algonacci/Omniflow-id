...
const screenshotKeys = ["tracking", "maintenance", "reporting"];
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					...
					<h2 className="text-enterprise-primary mb-6">
						{t("assetManagement.screenshots.title")}
					</h2>
					<p className="text-xl text-enterprise-secondary max-w-3xl mx-auto">
						{t("assetManagement.screenshots.subtitle")}
					</p>
				</div>

				<div className="space-y-20">
					{screenshotKeys.map((screenshotKey, index) => {
						const features = t(`assetManagement.screenshots.${screenshotKey}.features`, {
							returnObjects: true,
						});
								...
								>
									<div>
										<h3 className="text-3xl font-bold text-enterprise-primary mb-4">
											{t(`assetManagement.screenshots.${screenshotKey}.title`)}
										</h3>
										<p className="text-xl text-enterprise-secondary leading-relaxed">
											{t(`assetManagement.screenshots.${screenshotKey}.description`)}
										</p>
									</div>
									...
									<button className="btn-primary">
										{t("assetManagement.screenshots.exploreFeature")}
									</button>
								</div>
							</div>
						);
