...
export default function CTASection() {
	...
	const handlePrimaryCTA = () => {
		void trackCTAEvent({
			ctaKey: "accounting_cta_get_started",
			locale: currentLang,
	...
	const handleSecondaryCTA = () => {
		void trackCTAEvent({
			ctaKey: "accounting_cta_schedule_demo",
			locale: currentLang,
			moduleKey: "accounting",
		}).catch(() => undefined);
	};
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					<div>
						<div className="inline-flex items-center px-4 py-2 bg-blue-800 text-blue-100 rounded-full text-sm font-semibold mb-6">
							...
							{t("accounting.cta.badge")}
						</div>
						<h2 className="text-white mb-6">{t("accounting.cta.title")}</h2>
						...
						<div className="flex items-center space-x-6 text-blue-100">
							<div className="flex items-center">
								...
								<span className="text-sm">
									{t("accounting.cta.features.trial")}
								</span>
							</div>
							<div className="flex items-center">
								<CheckCircle className="h-4 w-4 mr-2" />
								<span className="text-sm">
									{t("accounting.cta.features.setup")}
								</span>
							</div>
							<div className="flex items-center">
								<CheckCircle className="h-4 w-4 mr-2" />
								<span className="text-sm">
									{t("accounting.cta.features.support")}
								</span>
							</div>
						</div>
					</div>
						...
						<div className="card-enterprise p-6 bg-white/10 backdrop-blur-sm border border-white/20">
							<div className="flex items-center space-x-4">
								...
								<div>
									...
									<div className="text-blue-100">
										{t("accounting.cta.stats.security")}
									</div>
								</div>
							</div>
						</div>
