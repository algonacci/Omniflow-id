...
const benefitKeys = ["accuracy", "compliance", "automation", "insights"];
const benefitIcons = [TrendingUp, Shield, Clock, DollarSign];
const benefitColors = [
						...
						return (
							...
							>
								...
								<div className="text-3xl font-bold text-blue-600 mb-2">
									{t(`accounting.benefits.${benefitKey}.stat`)}
								</div>
								<h3 className="text-xl font-bold text-enterprise-primary mb-3">
									{t(`accounting.benefits.${benefitKey}.title`)}
								</h3>
								<p className="text-enterprise-secondary leading-relaxed">
									{t(`accounting.benefits.${benefitKey}.description`)}
								</p>
							</div>
						);
					})}
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
							<div className="text-center">
								...
								<p className="text-enterprise-muted">
									{t("accounting.benefits.customers")}
								</p>
							</div>
							<div className="text-center">
