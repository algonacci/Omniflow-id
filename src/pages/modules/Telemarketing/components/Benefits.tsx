...
const benefitKeys = ["conversion", "efficiency", "compliance", "reach"];
const benefitIcons = [TrendingUp, Zap, Shield, Globe];
const benefitColors = [
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					<div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-6">
						...
						{t("telemarketing.benefits.badge")}
					</div>
						...
						return (
							...
							>
								...
								<div className="text-3xl font-bold text-blue-600 mb-2">
									{t(`telemarketing.benefits.${benefitKey}.stat`)}
								</div>
								<h3 className="text-xl font-bold text-enterprise-primary mb-3">
									{t(`telemarketing.benefits.${benefitKey}.title`)}
								</h3>
								<p className="text-enterprise-secondary leading-relaxed">
									{t(`telemarketing.benefits.${benefitKey}.description`)}
								</p>
							</div>
						);
					})}
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
							<div className="text-center">
								...
								<p className="text-enterprise-muted">
									{t("telemarketing.benefits.customers")}
								</p>
							</div>
							<div className="text-center">
								...
								<p className="text-enterprise-muted">
									{t("telemarketing.benefits.uptime")}
								</p>
							</div>
							<div className="text-center">
								...
								<p className="text-enterprise-muted">
									{t("telemarketing.benefits.support")}
								</p>
							</div>
						</div>
					</div>
