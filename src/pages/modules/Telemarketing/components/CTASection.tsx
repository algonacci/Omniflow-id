				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					<div>
						<div className="inline-flex items-center px-4 py-2 bg-blue-800 text-blue-100 rounded-full text-sm font-semibold mb-6">
							...
							{t("telemarketing.cta.badge")}
						</div>
						<h2 className="text-white mb-6">{t("telemarketing.cta.title")}</h2>
						<p className="text-blue-100 mb-8 text-xl leading-relaxed">
							{t("telemarketing.cta.subtitle")}
						</p>
						<div className="flex flex-col sm:flex-row gap-4 mb-8">
							<button className="btn-cta-light group">
								{t("telemarketing.cta.scheduleDemo")}
								<ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
							</button>
							<button className="btn-cta-outline">
								{t("telemarketing.cta.contactSales")}
							</button>
						</div>
						<div className="flex items-center space-x-6 text-blue-100">
							<div className="flex items-center">
								...
								<span className="text-sm">
									{t("telemarketing.cta.features.trial")}
								</span>
							</div>
							<div className="flex items-center">
								<CheckCircle className="h-4 w-4 mr-2" />
								<span className="text-sm">
									{t("telemarketing.cta.features.setup")}
								</span>
							</div>
							<div className="flex items-center">
								<CheckCircle className="h-4 w-4 mr-2" />
								<span className="text-sm">
									{t("telemarketing.cta.features.support")}
								</span>
							</div>
						</div>
					</div>
							...
							<div className="flex items-center space-x-4">
								...
								<div>
									...
									<div className="text-blue-100">
										{t("telemarketing.cta.stats.users")}
									</div>
								</div>
							</div>
						</div>
						...
						<div className="card-enterprise p-6 bg-white/10 backdrop-blur-sm border border-white/20">
							<div className="flex items-center space-x-4">
								...
								<div>
									...
									<div className="text-blue-100">
										{t("telemarketing.cta.stats.uptime")}
									</div>
								</div>
							</div>
						</div>
						...
						<div className="card-enterprise p-6 bg-white/10 backdrop-blur-sm border border-white/20">
							<div className="flex items-center space-x-4">
								...
								<div>
									...
									<div className="text-blue-100">
										{t("telemarketing.cta.stats.security")}
									</div>
								</div>
							</div>
						</div>
