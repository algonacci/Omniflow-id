...
const featureIcons = [Users, Mic, Phone, BarChart3, Headphones, MessageSquare];
const featureColors = [
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					<div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-6">
						...
						{t("telemarketing.features.badge")}
					</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{featureKeys.map((featureKey, index) => {
						...
						const benefits = t(
							`telemarketing.features.${featureKey}.benefits`,
							{
								returnObjects: true,
							}
						);
						...
						return (
							<div key={featureKey} className="card-feature group">
								...
								<h3 className="text-xl font-bold text-enterprise-primary mb-3 group-hover:text-blue-600 transition-colors">
									{t(`telemarketing.features.${featureKey}.title`)}
								</h3>
								<p className="text-enterprise-secondary leading-relaxed mb-4">
									{t(`telemarketing.features.${featureKey}.description`)}
								</p>
