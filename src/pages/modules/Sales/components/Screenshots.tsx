...
const screenshotKeys = ["pipeline", "analytics", "mobile"];
								...
								<div className={`${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
									<div className="relative">
										...
										<img
											...
											alt={t(`sales.screenshots.${screenshotKey}.title`)}
								...
								>
									<div>
										<h3 className="text-3xl font-bold text-enterprise-primary mb-4">
											{t(`sales.screenshots.${screenshotKey}.title`)}
										</h3>
										<p className="text-xl text-enterprise-secondary leading-relaxed">
											{t(`sales.screenshots.${screenshotKey}.description`)}
										</p>
									</div>
									...
									<button className="btn-primary">
										{t("sales.screenshots.exploreFeature")}
									</button>
								</div>
							</div>
						);
