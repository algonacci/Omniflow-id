import { Award, Eye, Shield, Zap, Globe } from "lucide-react";
import { useTranslation } from "react-i18next";

const benefitKeys = ["transparency","compliance","speed","reach"];
const benefitIcons = [Eye, Shield, Zap, Globe];
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
							<div className="text-center">
								...
								<p className="text-enterprise-muted">
									{t("ecf.benefits.organizations")}
								</p>
							</div>
							<div className="text-center">
								<div className="text-4xl font-bold text-indigo-600 mb-2">99.9%</div>
								<p className="text-enterprise-muted">
									{t("ecf.benefits.uptime")}
								</p>
							</div>
							<div className="text-center">
								<div className="text-4xl font-bold text-blue-600 mb-2">24/7</div>
								<p className="text-enterprise-muted">
									{t("ecf.benefits.support")}
								</p>
							</div>
						</div>
					</div>
