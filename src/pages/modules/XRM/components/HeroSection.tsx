			...
			<div className="container-enterprise">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
					<div className="space-y-8 animate-fade-in-left">
						...
						<h1 className="text-enterprise-primary">{t("xrm.hero.title")}</h1>
