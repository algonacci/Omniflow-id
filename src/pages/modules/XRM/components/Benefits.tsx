...
const benefitKeys = ["security", "scalable", "performance", "flexible"];
const benefitIcons = [CheckCircle, CheckCircle, Shield, TrendingUp];
const benefitColors = [
