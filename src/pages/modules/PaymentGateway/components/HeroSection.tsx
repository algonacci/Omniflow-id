				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
					<div className="space-y-8 animate-fade-in-left">
						...
						<div className="flex flex-col sm:flex-row gap-4">
							<button className="btn-primary group">
								{t("paymentGateway.cta.getStarted")}
						...
						<div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-gray-200">
							<div className="text-center">
								...
								<div className="text-sm text-enterprise-muted">
									{t("paymentGateway.hero.stats.users")}
								</div>
							</div>
							<div className="text-center">
								...
								<div className="text-sm text-enterprise-muted">
									{t("paymentGateway.hero.stats.uptime")}
								</div>
							</div>
							<div className="text-center">
								...
								<div className="text-sm text-enterprise-muted">
									{t("paymentGateway.hero.stats.saved")}
								</div>
							</div>
							<div className="text-center">
								...
								<div className="text-sm text-enterprise-muted">
									{t("paymentGateway.hero.stats.reduction")}
								</div>
							</div>
						</div>
					</div>
					...
					<div className="relative animate-fade-in-right">
						...
						<img
							...
							alt="Payment Gateway Dashboard Interface"
							...
							<div className="flex items-center space-x-4">
								...
								<div>
									<div className="font-semibold text-enterprise-primary">
										{t("paymentGateway.hero.productivityBoost")}
									</div>
