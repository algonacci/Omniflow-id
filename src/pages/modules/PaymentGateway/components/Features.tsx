...
const featureIcons = [Wallet, CreditCard, Shield, Zap, Receipt, BarChart3];
const featureColors = [
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					<div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-6">
						...
						{t("paymentGateway.features.badge")}
					</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{featureKeys.map((featureKey, index) => {
						...
						const benefits = t(
							`paymentGateway.features.${featureKey}.benefits`,
							{
								returnObjects: true,
							}
						);
						...
						return (
							<div key={featureKey} className="card-feature group">
								...
								<h3 className="text-xl font-bold text-enterprise-primary mb-3 group-hover:text-blue-600 transition-colors">
									{t(`paymentGateway.features.${featureKey}.title`)}
								</h3>
								<p className="text-enterprise-secondary leading-relaxed mb-4">
									{t(`paymentGateway.features.${featureKey}.description`)}
								</p>
