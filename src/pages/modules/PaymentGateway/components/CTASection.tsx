						...
						<div className="flex items-center space-x-6 text-blue-100">
							<div className="flex items-center">
								...
								<span className="text-sm">
									{t("paymentGateway.cta.features.trial")}
								</span>
							</div>
							<div className="flex items-center">
								<CheckCircle className="h-4 w-4 mr-2" />
								<span className="text-sm">
									{t("paymentGateway.cta.features.setup")}
								</span>
							</div>
							<div className="flex items-center">
								<CheckCircle className="h-4 w-4 mr-2" />
								<span className="text-sm">
									{t("paymentGateway.cta.features.support")}
								</span>
							</div>
						</div>
					</div>
							...
							<div className="flex items-center space-x-4">
								...
								<div>
									...
									<div className="text-blue-100">
										{t("paymentGateway.cta.stats.users")}
									</div>
								</div>
							</div>
						</div>
						...
						<div className="card-enterprise p-6 bg-white/10 backdrop-blur-sm border border-white/20">
							<div className="flex items-center space-x-4">
								...
								<div>
									...
									<div className="text-blue-100">
										{t("paymentGateway.cta.stats.uptime")}
									</div>
								</div>
							</div>
						</div>
						...
						<div className="card-enterprise p-6 bg-white/10 backdrop-blur-sm border border-white/20">
							<div className="flex items-center space-x-4">
								...
								<div>
									...
									<div className="text-blue-100">
										{t("paymentGateway.cta.stats.security")}
									</div>
								</div>
							</div>
						</div>
