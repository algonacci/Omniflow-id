...
export default function Testimonials() {
	...
	const testimonials = t("customers.testimonials.items", {
		returnObjects: true,
	}) as Array<{
		quote: string;
		author: string;
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-enterprise-secondary max-w-3xl mx-auto">
						{t("customers.testimonials.subtitle")}
					</p>
				</div>
				...
				<div className="mt-16 text-center">
					<div className="card-enterprise p-8 max-w-2xl mx-auto">
						<h3 className="text-2xl font-bold text-enterprise-primary mb-4">
							{t("customers.testimonials.joinSuccess.title")}
						</h3>
						<p className="text-enterprise-secondary mb-6">
							{t("customers.testimonials.joinSuccess.description")}
						</p>
						<button className="btn-primary">
							{t("customers.testimonials.joinSuccess.scheduleDemo")}
						</button>
					</div>
				</div>
			</div>
