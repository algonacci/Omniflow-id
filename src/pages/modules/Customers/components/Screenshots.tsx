...
const screenshotKeys = ["dashboard","profile","analytics"];
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					<div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-6">
						...
						{t("customers.screenshots.badge")}
					</div>
					<h2 className="text-enterprise-primary mb-6">
						{t("customers.screenshots.title")}
					</h2>
					<p className="text-xl text-enterprise-secondary max-w-3xl mx-auto">
						{t("customers.screenshots.subtitle")}
					</p>
				</div>

				<div className="space-y-20">
					{screenshotKeys.map((screenshotKey, index) => {
						const features = t(`customers.screenshots.${screenshotKey}.features`, {
							returnObjects: true,
						});
								...
								<div className={`${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
									<div className="relative">
										...
										<img
											...
											alt={t(`customers.screenshots.${screenshotKey}.title`)}
								...
								>
									<div>
										<h3 className="text-3xl font-bold text-enterprise-primary mb-4">
											{t(`customers.screenshots.${screenshotKey}.title`)}
										</h3>
										<p className="text-xl text-enterprise-secondary leading-relaxed">
											{t(`customers.screenshots.${screenshotKey}.description`)}
										</p>
									</div>
									...
									<button className="btn-primary">
										{t("customers.screenshots.exploreFeature")}
									</button>
								</div>
							</div>
						);
