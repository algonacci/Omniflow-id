...
const featureKeys = ["online","calendar","resources","payments","notifications","analytics"];
const featureIcons = [Globe, Calendar, Layers, CreditCard, Bell, BarChart];
const featureColors = [
			...
			<div className="container-enterprise">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{featureKeys.map((featureKey, index) => {
						...
						const benefits = t(`bookingEngine.features.${featureKey}.benefits`, {
							returnObjects: true,
						});
						...
						return (
							<div key={featureKey} className="card-feature group">
								...
								<h3 className="text-xl font-bold text-enterprise-primary mb-3 group-hover:text-blue-600 transition-colors">
									{t(`bookingEngine.features.${featureKey}.title`)}
								</h3>
								<p className="text-enterprise-secondary leading-relaxed mb-4">
									{t(`bookingEngine.features.${featureKey}.description`)}
								</p>
