...
export default function Testimonials() {
	...
	const testimonials = t("bookingEngine.testimonials.items", {
		returnObjects: true,
	}) as Array<{
		quote: string;
		author: string;
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					<div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-6">
						...
						{t("bookingEngine.testimonials.badge")}
					</div>
					<h2 className="text-enterprise-primary mb-6">
						{t("bookingEngine.testimonials.title")}
					</h2>
					<p className="text-xl text-enterprise-secondary max-w-3xl mx-auto">
						{t("bookingEngine.testimonials.subtitle")}
					</p>
				</div>
				...
				<div className="mt-16 text-center">
					<div className="card-enterprise p-8 max-w-2xl mx-auto">
						<h3 className="text-2xl font-bold text-enterprise-primary mb-4">
							{t("bookingEngine.testimonials.joinSuccess.title")}
						</h3>
						<p className="text-enterprise-secondary mb-6">
							{t("bookingEngine.testimonials.joinSuccess.description")}
						</p>
						<button className="btn-primary">
							{t("bookingEngine.testimonials.joinSuccess.scheduleDemo")}
						</button>
					</div>
				</div>
			</div>
