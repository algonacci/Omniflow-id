...
const benefitKeys = ["fast", "reliable", "integrated", "flexible"];
						...
						return (
							...
							>
								...
								<p className="text-enterprise-secondary leading-relaxed">
									{t(`pos.benefits.${benefitKey}.description`)}
								</p>
							</div>
						);
					})}
