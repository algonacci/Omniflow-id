			...
			<div className="container-enterprise">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
					<div className="space-y-8 animate-fade-in-left">
						<div className="inline-flex items-center px-4 py-2 bg-sky-100 text-sky-800 rounded-full text-sm font-semibold">
							<CheckCircle className="h-4 w-4 mr-2" />
							{t("inventory.badge")}
						</div>

						<h1 className="text-enterprise-primary">{t("inventory.title")}</h1>
						...
						<div className="flex flex-col sm:flex-row gap-4">
							<button className="btn-primary group">
								{t("inventory.hero.scheduleDemo")}
								<ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
							</button>
							<button className="btn-secondary group">
								<Play className="mr-2 h-5 w-5" />
								{t("inventory.hero.watchOverview")}
							</button>
						</div>
						...
						<div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-gray-200">
							<div className="text-center">
								...
								<div className="text-2xl font-bold text-sky-600">40K+</div>
								<div className="text-sm text-enterprise-muted">
									{t("inventory.hero.stats.users")}
								</div>
							</div>
							<div className="text-center">
							...
							<div className="text-center">
								...
								<div className="text-sm text-enterprise-muted">
									{t("inventory.hero.stats.reduction")}
								</div>
							</div>
							<div className="text-center">
								...
								<div className="text-sm text-enterprise-muted">
									{t("inventory.hero.stats.accuracy")}
								</div>
							</div>
						</div>
					</div>
					...
					<div className="relative animate-fade-in-right">
						<div className="absolute inset-0 bg-gradient-to-r from-sky-600/20 to-blue-700/20 rounded-3xl transform rotate-3"></div>
						<img
							src="https://images.unsplash.com/photo-1553852521-ff0c65d71ca9?auto=format&fit=crop&q=80&w=800"
							...
							<div className="flex items-center space-x-4">
								...
								<div>
									<div className="font-semibold text-enterprise-primary">
										{t("inventory.hero.accuracyBoost")}
									</div>
