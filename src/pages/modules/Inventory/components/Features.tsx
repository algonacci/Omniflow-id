			...
			<div className="container-enterprise">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{featureKeys.map((featureKey, index) => {
						...
						const benefits = t(`inventory.features.${featureKey}.benefits`, {
							returnObjects: true,
						});
						...
						return (
							<div key={featureKey} className="card-feature group">
								...
								<p className="text-enterprise-secondary leading-relaxed mb-4">
									{t(`inventory.features.${featureKey}.description`)}
								</p>
