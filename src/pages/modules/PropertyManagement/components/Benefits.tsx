import { Award, CreditCard, Clock, Building } from "lucide-react";
import { useTranslation } from "react-i18next";

const benefitKeys = ["collection","efficiency","occupancy","satisfaction"];
const benefitIcons = [CreditCard, Clock, Building, Award];
const benefitColors = ["from-blue-500 to-blue-600","from-indigo-500 to-indigo-600","from-sky-500 to-sky-600","from-cyan-500 to-cyan-600"];
			...
			<div className="container-enterprise">
				<div className="text-center mb-16">
					<div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold mb-6">
						...
						{t("propertyManagement.benefits.badge")}
					</div>
					...
					<p className="text-xl text-enterprise-secondary max-w-3xl mx-auto">
						{t("propertyManagement.benefits.subtitle")}
					</p>
				</div>
						...
						return (
							<div key={benefitKey} className="card-enterprise p-8 text-center group">
								...
								<div className="text-3xl font-bold text-blue-600 mb-2">
									{t(`propertyManagement.benefits.${benefitKey}.stat`)}
								</div>
								<h3 className="text-xl font-bold text-enterprise-primary mb-3">
									{t(`propertyManagement.benefits.${benefitKey}.title`)}
								</h3>
								<p className="text-enterprise-secondary leading-relaxed">
									{t(`propertyManagement.benefits.${benefitKey}.description`)}
								</p>
							</div>
						);
					})}
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
							<div className="text-center">
								...
								<p className="text-enterprise-muted">
									{t("propertyManagement.benefits.organizations")}
								</p>
							</div>
							<div className="text-center">
								<div className="text-4xl font-bold text-indigo-600 mb-2">99.9%</div>
								<p className="text-enterprise-muted">
									{t("propertyManagement.benefits.uptime")}
								</p>
							</div>
							<div className="text-center">
								<div className="text-4xl font-bold text-blue-600 mb-2">24/7</div>
								<p className="text-enterprise-muted">
									{t("propertyManagement.benefits.support")}
								</p>
							</div>
						</div>
					</div>
