				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					<div>
						<div className="inline-flex items-center px-4 py-2 bg-blue-800 text-blue-100 rounded-full text-sm font-semibold mb-6">
							...
							{t("commerce.cta.badge")}
						</div>
						<h2 className="text-white mb-6">{t("commerce.cta.title")}</h2>
						...
						<div className="flex items-center space-x-6 text-blue-100">
							<div className="flex items-center">
								...
								<span className="text-sm">
									{t("commerce.cta.features.trial")}
								</span>
							</div>
							<div className="flex items-center">
								<CheckCircle className="h-4 w-4 mr-2" />
								<span className="text-sm">
									{t("commerce.cta.features.setup")}
								</span>
							</div>
							<div className="flex items-center">
								<CheckCircle className="h-4 w-4 mr-2" />
								<span className="text-sm">
									{t("commerce.cta.features.support")}
								</span>
							</div>
						</div>
					</div>
