...
const benefitKeys = ["easy", "secure", "fast", "automated"];
						...
						return (
							...
							>
								...
								<div className="text-3xl font-bold text-blue-600 mb-2">
									{t(`commerce.benefits.${benefitKey}.stat`)}
								</div>
								<h3 className="text-xl font-bold text-enterprise-primary mb-3">
									{t(`commerce.benefits.${benefitKey}.title`)}
								</h3>
								<p className="text-enterprise-secondary leading-relaxed">
									{t(`commerce.benefits.${benefitKey}.description`)}
								</p>
							</div>
						);
					})}
